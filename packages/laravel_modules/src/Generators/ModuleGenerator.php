...
class ModuleGenerator extends Generator
{
    ...
    public function generate(): int
    {
        ...
        // must be called after service provider generation
    ...
    {
        $menuGenerator = new MenuGenerator($this->module, $this->getName(),$this->component);
        $menuGenerator->generate();
    }

    protected function generateSettingsConfig(): void
    {
        $settingsGenerator = new ModuleSettingsGenerator($this->module, $this->getName(), $this->component);
